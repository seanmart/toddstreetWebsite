<template lang="html">
  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
     ...
     class="vf">
  <g>
  	<path class="body" d="M339.1,112.8c-6.7-31.1-18.7-60.3-32.2-88.9c-4.2-8.9-12-13.5-21.5-15.4C257.9,3,230.2-0.3,205.3,0
...
.vf:hover .body {
  animation: balance 1.5s ease-in-out 110ms infinite;
