export default{
  intro:{
    title: `we are content creators, we transform <br/> an audience into something bigger,<br/> motivating them to think, feel and act.`,
    text: ` we transform an audience into something bigger, <br/> motivating them to think, feel and act.`,
    roles:[
      `Content Creators`,
